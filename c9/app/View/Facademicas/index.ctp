<div class="facademicas index">
	<h2><?php echo __('Faltan de credito academico'); ?></h2>
...
<div class="col-md-12">
	...
	<tbody>
	<?php foreach ($facademicas as $facademica): ?>
	<tr>
		<td><?php echo h($facademica['Facademica']['id']); ?>&nbsp;</td>
		<td><?php echo h($facademica['Facademica']['matricula']); ?>&nbsp;</td>
		<td><?php echo h($facademica['Facademica']['nombre']); ?>&nbsp;</td>
		<td><?php echo h($facademica['Facademica']['apellidopaterno']); ?>&nbsp;</td>
		<td><?php echo h($facademica['Facademica']['apellidomaterno']); ?>&nbsp;</td>
		<td><?php echo h($facademica['Facademica']['semestre']); ?>&nbsp;</td>
	</tr>
<?php endforeach; ?>
	</tbody>
	</table>
